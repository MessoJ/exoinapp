  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-slate-500">Manage your company and email hosting settings</p>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 font-mono"
                />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Secondary Color (Accent)</label>
              <div className="flex items-center gap-3">
                <input
                  type="color"
                  name="secondaryColor"
          ...
          <div className="mt-4 p-4 bg-slate-50 rounded-lg">
            ...
            <div className="flex items-center gap-4">
              <div 
                className="w-24 h-12 rounded-lg flex items-center justify-center text-white font-medium text-sm"
              ...
              <div 
                className="flex-1 h-12 rounded-lg flex items-center justify-between px-4"
                style={{ backgroundColor: formData.primaryColor }}
              >
                <span className="text-white font-medium">{formData.name || 'Company Name'}</span>
                <span style={{ color: formData.secondaryColor }} className="font-bold">INVOICE</span>
              </div>
            </div>
          </div>
        </div>
