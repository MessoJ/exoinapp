          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent w-72"
              />
            </div>
          </div>
            ...
            <div className="relative">
              ...
              {userMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 bg-white border border-slate-200 rounded-lg shadow-lg py-2 w-48 z-50">
                    ...
                    <Link 
                      ...
                      className="w-full flex items-center gap-2 px-4 py-2 text-slate-600 hover:bg-slate-50 text-sm"
                    >
                      <Settings size={16} />
                      Settings
                    </Link>
